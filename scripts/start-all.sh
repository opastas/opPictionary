...
echo "======================================"
echo "📊 Service Status:"
echo "   Server:  http://192.168.1.6:4000"
echo "   Web:     http://192.168.1.6:$ACTUAL_WEB_PORT"
echo "   Mobile:  exp://192.168.1.6:$ACTUAL_MOBILE_PORT"
echo ""
echo "🔗 Access URLs:"
echo "   Web App:    http://192.168.1.6:$ACTUAL_WEB_PORT"
echo "   Mobile:     Scan QR code in terminal"
echo "   Server API: http://192.168.1.6:4000/health"
echo ""
